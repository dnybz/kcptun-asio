...
void smux::do_keepalive_checker() {
    ...
    if (!keepalive_check_timer_) {
        keepalive_check_timer_ = std::make_shared<asio::steady_timer>(
...
void smux::do_keepalive_sender() {
    ...
    if (!keepalive_sender_timer_) {
        keepalive_sender_timer_ = std::make_shared<asio::steady_timer>(
...
void smux::do_stat_checker() {
    ...
    auto stat_timer = std::make_shared<asio::steady_timer>(
